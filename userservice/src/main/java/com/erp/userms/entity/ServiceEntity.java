...
public class ServiceEntity {
    ...
    @ManyToMany
    @JoinTable(
            name = "service_api_permissions",
            joinColumns = @JoinColumn(name = "service_id"),
            inverseJoinColumns = @JoinColumn(name = "api_permission_id")
    )
    private List<ApiPermissionEntity> ApiPermissionEntity = new ArrayList<>();
    ...
    public List<ApiPermissionEntity> getApiPermissionEntity() {
        return ApiPermissionEntity;
    }

    public void setApiPermissionEntity(List<ApiPermissionEntity> apiPermissionEntity) {
        ApiPermissionEntity = apiPermissionEntity;
    }
