...
public class RoleController {
    ...
    public ResponseBO createRole(@RequestBody RoleDTO roleDTO) {
        try {
            if (roleServiceInterface.isRoleExists(roleDTO.getRole())) {
                return new ResponseBO(HttpStatus.CONFLICT.value(), HttpStatus.CONFLICT.getReasonPhrase(),null,roleDTO.getRole()+" "+ StatusConstant.EXISTS);
            }
            ...
            return new ResponseBO(HttpStatus.CREATED.value(), HttpStatus.CREATED.getReasonPhrase(), createdRole, StatusConstant.CREATED);
        } catch (Exception ex) {
    ...
    public ResponseBO updateRole(@RequestBody RoleDTO roleDTO, @PathVariable Long roleId) {
        try {
            ...
            if (updatedRole == null) {
                ...
                return new ResponseBO(HttpStatus.CONFLICT.value(),HttpStatus.CONFLICT.getReasonPhrase(),null,name+" "+ StatusConstant.EXISTS);
            }

            LOGGER.info("Role details updated successfully");
            return new ResponseBO(HttpStatus.OK.value(), HttpStatus.OK.getReasonPhrase(), updatedRole, StatusConstant.UPDATED);
        } catch (Exception ex) {
            LOGGER.error("An error occurred while processing the request", ex);
            return new ResponseBO(HttpStatus.INTERNAL_SERVER_ERROR.value(),HttpStatus.INTERNAL_SERVER_ERROR.getReasonPhrase(),null, StatusConstant.INTERNAL_SERVER_ERROR);
        } finally {
    ...
    public ResponseBO getRoleById(@PathVariable Long roleId) {
        try {
            ...
            if (role != null) {
                ...
                return new ResponseBO(HttpStatus.OK.value(), HttpStatus.OK.getReasonPhrase(), role, StatusConstant.GET);
            } else {
    ...
    public ResponseBO getAllRoles() {
        try {
            ...
            if(!roles.isEmpty()){
                return new ResponseBO(HttpStatus.OK.value(), HttpStatus.OK.getReasonPhrase(), roles, roles.size()+ " " + StatusConstant.GET_LIST);
            } else {
    ...
    public ResponseBO getRoleByUserId(@PathVariable Long userId) {
        try {
            ...
            return new ResponseBO(HttpStatus.OK.value(), HttpStatus.OK.getReasonPhrase(), roleDTO, StatusConstant.GET);
        } catch (IllegalArgumentException ex) {
            LOGGER.warn("Role not found for user ID: {}", userId);
            return new ResponseBO(HttpStatus.NOT_FOUND.value(),HttpStatus.NOT_FOUND.getReasonPhrase(),null,"Role" +" "+ StatusConstant.NOT_FOUND);
        } catch (Exception ex) {
            LOGGER.error("An error occurred while processing the request", ex);
            return new ResponseBO(HttpStatus.INTERNAL_SERVER_ERROR.value(),HttpStatus.INTERNAL_SERVER_ERROR.getReasonPhrase(),null,StatusConstant.INTERNAL_SERVER_ERROR);
        }
    ...
    public ResponseBO deleteRoleById(@PathVariable Long roleId) {
        try {
            ...
            if(Objects.equals(delete.getRole(), "true")){
                return new ResponseBO(HttpStatus.CONFLICT.value(),HttpStatus.CONFLICT.getReasonPhrase(),null,"Role" +" "+ StatusConstant.MERGE);
            }
    ...
    public ResponseBO createRoleDefaultPermission(@RequestBody RoleDefaultPermissionDTO roleDefaultPermissionDTO) {
        try {
            ...
            return new ResponseBO(HttpStatus.CREATED.value(), HttpStatus.CREATED.getReasonPhrase(), createdRoleDefaultPermission, StatusConstant.CREATED);
        } catch (Exception ex) {
            LOGGER.error("An error occurred while processing the request", ex);
            return new ResponseBO(HttpStatus.INTERNAL_SERVER_ERROR.value(),HttpStatus.INTERNAL_SERVER_ERROR.getReasonPhrase(),null,StatusConstant.INTERNAL_SERVER_ERROR);
        }
    ...
    public ResponseBO updateRoleDefaultPermission(@PathVariable Long roleDefaultPermissionId, @RequestBody RoleDefaultPermissionDTO roleDefaultPermissionDTO) {
        try {
            ...
            if (updatedRoleDefaultPermission == null) {
                return new ResponseBO(HttpStatus.NOT_FOUND.value(),HttpStatus.NOT_FOUND.getReasonPhrase(),null,"RoleDefaultPermission Id" +" "+roleDefaultPermissionId+" "+ StatusConstant.NOT_FOUND);
            } else {
                LOGGER.info("Exiting updateRoleDefaultPermission method successfully");
                return new ResponseBO(HttpStatus.OK.value(), HttpStatus.OK.getReasonPhrase(), updatedRoleDefaultPermission, StatusConstant.UPDATED);
            }
        } catch (Exception ex) {
            LOGGER.error("An error occurred while processing the request", ex);
            return new ResponseBO(HttpStatus.INTERNAL_SERVER_ERROR.value(),HttpStatus.INTERNAL_SERVER_ERROR.getReasonPhrase(),null,StatusConstant.INTERNAL_SERVER_ERROR);
    ...
    public ResponseBO getDefaultPermission() {
        try {
            ...
            return new ResponseBO(HttpStatus.OK.value(), HttpStatus.OK.getReasonPhrase(), jsonDataAsObject, StatusConstant.GET);
    ...
    public ResponseBO deleteRoleDefaultPermissionById(@PathVariable Long roleDefaultPermissionId) {
        ...
        try {
            ...
            if(delete){
                return new ResponseBO(HttpStatus.CONFLICT.value(),HttpStatus.CONFLICT.getReasonPhrase(),null,"Default Permission" +" "+ StatusConstant.MERGE);
            }
