...
import com.erp.userms.DTO.PermissionDTO;
import com.erp.userms.service.Interface.PermissionServiceInterface;
...
public class PermissionController {
    ...
    public ResponseBO createPermission(@RequestBody PermissionDTO permissionDTO) {
        try {
            if (permissionServiceInterface.isPermissionNameExists(permissionDTO.getPermissionName())) {
                return new ResponseBO(HttpStatus.CONFLICT.value(),HttpStatus.CONFLICT.getReasonPhrase(),null,permissionDTO.getPermissionName() +" "+ StatusConstant.EXISTS);
            }
            else if (!permissionServiceInterface.isUserIdExists(permissionDTO.getUserId())) {
                return new ResponseBO(HttpStatus.NOT_FOUND.value(),HttpStatus.NOT_FOUND.getReasonPhrase(),null,"User"+" "+StatusConstant.NOT_FOUND);
            }
            ...
            return new ResponseBO(HttpStatus.CREATED.value(), HttpStatus.CREATED.getReasonPhrase(), createdPermission, StatusConstant.CREATED);
        } catch (Exception ex) {
    ...
    public ResponseBO updatePermission(@RequestBody PermissionDTO permissionDTO, @PathVariable Long permissionId) {
        try {
            ...
            if (updatedPermission == null) {
                return new ResponseBO(HttpStatus.NOT_FOUND.value(),HttpStatus.NOT_FOUND.getReasonPhrase(),null, "Permission Id" +" "+ StatusConstant.NOT_FOUND);
            ...
            return new ResponseBO(HttpStatus.OK.value(), HttpStatus.OK.getReasonPhrase(), updatedPermission, StatusConstant.UPDATED);
        } catch (Exception ex) {
            LOGGER.error("An error occurred while processing the request", ex);
            return new ResponseBO(HttpStatus.INTERNAL_SERVER_ERROR.value(),HttpStatus.INTERNAL_SERVER_ERROR.getReasonPhrase(),null,StatusConstant.INTERNAL_SERVER_ERROR);
        }
    ...
    public ResponseBO getPermissionById(@PathVariable Long permissionId) {
        if (permissionServiceInterface.isPermissionIdExists(permissionId)) {
            try {
                ...
                return new ResponseBO(HttpStatus.OK.value(), HttpStatus.OK.getReasonPhrase(), permission, StatusConstant.GET);
            } catch (Exception ex) {
                LOGGER.error("An error occurred while processing the request", ex);
                return new ResponseBO(HttpStatus.INTERNAL_SERVER_ERROR.value(),HttpStatus.INTERNAL_SERVER_ERROR.getReasonPhrase(),null,StatusConstant.INTERNAL_SERVER_ERROR);
            }
    ...
    public ResponseBO getAllPermissions() {
        try {
            ...
            if (!permissionDTOList.isEmpty()) {
                return new ResponseBO(HttpStatus.OK.value(), HttpStatus.OK.getReasonPhrase(), permissionDTOList, permissionDTOList.size()+ " "+ StatusConstant.GET_LIST);
            } else {
    ...
    public ResponseBO getByUserId(@PathVariable("userId") Long userId) {
        try {
            ...
            return new ResponseBO(HttpStatus.OK.value(), HttpStatus.OK.getReasonPhrase(), permissionDTO, StatusConstant.GET);
        } catch (IllegalArgumentException e) {
            LOGGER.warn("User ID {} not found", userId);
            return new ResponseBO(HttpStatus.NOT_FOUND.value(),HttpStatus.NOT_FOUND.getReasonPhrase(),null,"Permission"+" "+StatusConstant.NOT_FOUND);
        } catch (Exception ex) {
            LOGGER.error("An error occurred while processing the request", ex);
            return new ResponseBO(HttpStatus.INTERNAL_SERVER_ERROR.value(),HttpStatus.INTERNAL_SERVER_ERROR.getReasonPhrase(),null,StatusConstant.INTERNAL_SERVER_ERROR);
        }
    ...
    public ResponseBO deletePermission(@PathVariable Long permissionId) {
        try {
            ...
            if(Objects.equals(delete.getPermissionName(), "true")){
                return new ResponseBO(HttpStatus.CONFLICT.value(),HttpStatus.CONFLICT.getReasonPhrase(),null,"Permission"+" "+StatusConstant.MERGE);
            }
