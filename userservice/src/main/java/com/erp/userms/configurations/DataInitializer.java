package com.erp.userms.configurations;

import com.DTO.common.ResponseBO;
import com.erp.userms.DTO.AddressDTO;
import com.erp.userms.DTO.OrganizationDTO;
import com.erp.userms.DTO.RoleDTO;
import com.erp.userms.DTO.UserDTO;
import com.erp.userms.controller.RoleController;
import com.erp.userms.controller.UserController;
import com.erp.userms.entity.RoleEntity;
import com.erp.userms.entity.UserEntity;
import com.erp.userms.repository.IRoleRepo;
    ...
    private void createDefaultRole() {
        ...
        if (existingRoleEntity != null) {
            if (existingRoleEntity.getDescription().equals(superAdminDescription)) {
                ...
                if (updateResponse.getCode() == HttpStatus.OK.value()) {
            ...
            if (createResponse.getCode() == HttpStatus.CREATED.value()) {
